...
<body>
    <header>
        <div class="header-top">
            <img class="logo" src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Google_2015_logo.svg/1024px-Google_2015_logo.svg.png" alt="">
    ...
    <main>
        <ul><?php foreach($faqs as $key => $faq) { ?>
            <li>
